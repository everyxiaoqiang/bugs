...
<?
  @$result_data_desc = mysql_query("select wybug_date,wybug_corp,count(DISTINCT wybug_id) as count from bugs group by wybug_corp order by SUM(wybug_rank_fromcorp) desc limit 30");
