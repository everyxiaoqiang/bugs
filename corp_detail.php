...
<title> <? echo @$bugs_corp['wybug_corp'];?> | 乌云网 | WooYun.org </title>
...
<div class="weibo"><iframe width="136" height="24" frameborder="0" allowtransparency="true" marginwidth="0" marginheight="0" scrolling="no" border="0" src="http://widget.weibo.com/relationship/followbutton.php?language=zh_cn&width=136&height=24&uid=1981622273&style=2&btn=red&dpc=1"></iframe>
	...
	<div class="bread" style="padding-top: 4px;">
		<div style="float:left">当前位置：<a href="index.php">首页</a> >> <a href="whitehat_detail.php?whitehat=<? echo @$whitehats['whitehat'];?>">厂商信息</a></div>
			</div>
<div class="content">
<!--头像标签开始-->
<input type="hidden" id="token" style="display:none" value="" />
		<h3 style="font-size:18px;font:font:Microsoft YaHei,Helvetica,Arial,Sans-Serif;padding:0 0 5px 0"><a href="corp_detail.php?corp=<?echo @$bugs_corp['wybug_corp'];?>" style="font-size:20px;color:#000000"><strong><? echo $bugs_corp['wybug_corp']?></strong></a></h3>
		...
		<p style="text-align:left;line-height:35px;background-color:#d0d0d0;padding:0 0 0 20px;">感谢 <?while(@$row00 = mysql_fetch_array($corp_authors)){
			echo '<a href="whitehat_detail.php?whitehat=';
			echo @$row00['wybug_author'].'">'.@$row00['wybug_author'].'</a> ';
			
		}?>对 <?echo $bugs_corp['wybug_corp'];?>   的信息安全做出的贡献</p>
		</div>
