...
<div class="weibo"><iframe width="136" height="24" frameborder="0" allowtransparency="true" marginwidth="0" marginheight="0" scrolling="no" border="0" src="http://widget.weibo.com/relationship/followbutton.php?language=zh_cn&width=136&height=24&uid=1981622273&style=2&btn=red&dpc=1"></iframe>
	...
	<div class="bread" style="padding-top: 4px;">
		<div style="float:left">当前位置：<a href="index.php">首页</a> >> <a href="whitehat_detail.php?whitehat=<? echo @$whitehats['whitehat'];?>">白帽子信息</a></div>
			</div>
<div class="content">
<!--头像标签开始-->
...
<!--头像标签结束-->
	 ...
	 <span style="display:inline;"><a href="whitehat_detail.php?whitehat=<? echo $whitehats['whitehat'];?>" style="font-size:20px;color:#000000"><strong><? echo $whitehats['whitehat'];?></strong></a> <p style="display:inline;font-size:16px;color:#8E8E8E">( 路人 | Rank: <? echo $whitehats['Ranks'];?> )</p></span>
	 <p style="padding:8px 0 0 0;">他于 <? echo @$whitehats['join_date'];?> 注册，已来到乌云 164 天</p>
